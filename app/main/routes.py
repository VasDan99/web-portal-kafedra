...
def student_works_upload():
    ...
    return render_template('cabinet/student_works.html', breadcrumb_title='Мои работы', student=student, form=form,
                           works=works)
...
# ==================== Настройки (смена пароля, обновление данных) ====================
